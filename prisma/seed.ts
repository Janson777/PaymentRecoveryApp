...
async function main() {
  ...
  const case1 = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 95,
      openedAt: hoursAgo(3),
      suppressionUntil: new Date(hoursAgo(3).getTime() + 90 * 60 * 1000),
      readyAt: hoursAgo(2),
  ...
  const case4 = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 95,
      openedAt: hoursAgo(8),
      suppressionUntil: new Date(hoursAgo(8).getTime() + 90 * 60 * 1000),
      readyAt: hoursAgo(7),
      closedAt: hoursAgo(6),
  ...
  const caseJake = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 92,
      openedAt: daysAgo(5),
      suppressionUntil: new Date(daysAgo(5).getTime() + 90 * 60 * 1000),
      readyAt: daysAgo(5),
      closedAt: daysAgo(4),
      closeReason: "order_paid",
      primaryReasonCode: "card_declined",
  ...
  const caseTom = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 97,
      openedAt: daysAgo(2),
      suppressionUntil: new Date(daysAgo(2).getTime() + 90 * 60 * 1000),
      readyAt: daysAgo(2),
      closedAt: daysAgo(1),
      closeReason: "order_paid",
      primaryReasonCode: "card_declined",
  ...
  const caseLisa = await prisma.recoveryCase.create({
    data: {
      ...
      suppressionUntil: new Date(hoursAgo(13).getTime() + 90 * 60 * 1000),
      readyAt: hoursAgo(12),
  ...
  const caseKevin = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 85,
      openedAt: hoursAgo(9),
      suppressionUntil: new Date(hoursAgo(9).getTime() + 90 * 60 * 1000),
      readyAt: hoursAgo(8),
      primaryReasonCode: "card_declined",
      plannedSequenceJson: shop1PlannedSeq,
      notesJson: [
  ...
  const caseSarah = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 93,
      openedAt: hoursAgo(7),
      suppressionUntil: new Date(hoursAgo(7).getTime() + 90 * 60 * 1000),
      readyAt: hoursAgo(6),
      primaryReasonCode: "insufficient_funds",
      plannedSequenceJson: shop1PlannedSeq,
      notesJson: [
  ...
  const caseMike = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 91,
      openedAt: daysAgo(7),
      suppressionUntil: new Date(daysAgo(7).getTime() + 90 * 60 * 1000),
      readyAt: daysAgo(7),
      closedAt: daysAgo(4),
  ...
  const caseRachel = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 87,
      openedAt: daysAgo(6),
      suppressionUntil: new Date(daysAgo(6).getTime() + 90 * 60 * 1000),
      readyAt: daysAgo(6),
      closedAt: daysAgo(3),
      closeReason: "expired_no_recovery",
  ...
  const caseLeo = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 88,
      openedAt: hoursAgo(7),
      suppressionUntil: new Date(hoursAgo(7).getTime() + 60 * 60 * 1000),
      readyAt: hoursAgo(6),
      primaryReasonCode: "card_declined",
      plannedSequenceJson: shop2PlannedSeq,
      notesJson: [
  ...
  const caseJen = await prisma.recoveryCase.create({
    data: {
      ...
      confidenceScore: 94,
      openedAt: daysAgo(3),
      suppressionUntil: new Date(daysAgo(3).getTime() + 60 * 60 * 1000),
      readyAt: daysAgo(3),
      closedAt: daysAgo(2),
      closeReason: "order_paid",
      primaryReasonCode: "insufficient_funds",
